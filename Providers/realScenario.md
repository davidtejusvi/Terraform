...
# Module 3 — AWS Resources with Real-Time Scenarios
...
3. EC2, EBS, Elastic IP
4. ALB, Launch Templates, Auto Scaling Groups
5. S3, CloudFront, Route 53, ACM
6. RDS, DynamoDB, EFS
7. CloudWatch, SNS, SQS
